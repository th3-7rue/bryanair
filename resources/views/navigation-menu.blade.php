<nav x-data="{ open: false }" class="dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100 bg-white">
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="dark:text-gray-400 dark:bg-gray-800 dark:hover:text-gray-300 dark:focus:bg-gray-700 dark:active:bg-gray-700 inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:bg-gray-50 focus:outline-none active:bg-gray-50">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    @if (Auth::user()->allTeams()->count() > 1)
                                        <div class="dark:border-gray-600 border-t border-gray-200"></div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="dark:border-gray-600 border-t border-gray-200 pb-1 pt-4">
